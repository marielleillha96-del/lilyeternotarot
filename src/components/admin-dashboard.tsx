      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        ...
        {tab === 'services' ? (
          <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
            <aside className="rounded-[28px] border border-white/8 bg-white/[0.04] p-4">
              <div className="flex items-center justify-between gap-3">
                <h3 className="font-display text-xl text-white">Consultas</h3>
                <button
                  type="button"
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <p className="mt-1 text-xs uppercase tracking-[0.26em] text-stone-500">{service.category}</p>
                      </div>
                      <span className="rounded-full bg-white/10 px-2.5 py-1 text-xs text-amber-100">
            ...
            <section className="rounded-[28px] border border-white/8 bg-white/[0.04] p-4 sm:p-6">
              {serviceDraft ? (
                <div className="space-y-5">
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                      <p className="text-xs uppercase tracking-[0.35em] text-amber-200/75">Editar consulta</p>
                      <h3 className="mt-2 font-display text-2xl text-white">{serviceDraft.title}</h3>
                    </div>
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 rounded-full border border-rose-400/20 bg-rose-400/10 px-4 py-2 text-sm text-rose-100"
                      >
                        <Icon name="trash" />
                        Excluir
                      </button>
          ...
          <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
            <aside className="rounded-[28px] border border-white/8 bg-white/[0.04] p-4">
              <div className="flex items-center justify-between gap-3">
                <h3 className="font-display text-xl text-white">Feedbacks</h3>
                <button
                  type="button"
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <p className="truncate font-medium text-white">{testimonial.title}</p>
                        <p className="mt-1 text-xs uppercase tracking-[0.26em] text-stone-500">Feedback</p>
                      </div>
                    </div>
                  </button>
                ))}
            ...
            <section className="rounded-[28px] border border-white/8 bg-white/[0.04] p-4 sm:p-6">
              {testimonialDraft ? (
                <div className="space-y-5">
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                      <p className="text-xs uppercase tracking-[0.35em] text-amber-200/75">Editar feedback</p>
                      <h3 className="mt-2 font-display text-2xl text-white">{testimonialDraft.title}</h3>
                    </div>
                    <div className="flex gap-2">
                      <button
                        type="button"
